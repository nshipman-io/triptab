...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        default: "bg-forest text-cream hover:bg-forest-light hover:-translate-y-0.5 hover:shadow-lg",
        destructive:
        ...
        ghost: "hover:bg-sand hover:text-forest",
        link: "text-forest underline-offset-4 hover:underline hover:text-terracotta",
        terracotta: "bg-gradient-to-r from-terracotta to-terracotta-light text-cream hover:-translate-y-0.5 hover:shadow-lg",
      },
      size: {
